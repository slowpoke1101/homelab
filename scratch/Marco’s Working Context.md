...
8 - pvid 1 - 88, 99 tagged flint2 plugged in and broadcasting my lan, roommate's lan, and iot/guest

Marco’s network uses multiple VLANs across Tai:

    LAN (VLAN 1) — 192.168.33.0/25

    V88 (VLAN 88) — 10.1.88.0/25 (roommate’s devices sensitive to jitter)
...
OLD topology was WAN > Flint2(roommate's lan) > mimi > my network. but ive since then changed it to WAN > Mimi > everything else
i mention this because it is easy for me to switch back and forth and change configs accordingly, and this is a possibility if my roommate's jitter
issues continue.
